...
plt.savefig('average', bbox_inches='tight', pad_inches=.2)
plt.close()
...
plt.xticks(index + .5, ('Food Est.', 'Corner Store', 'Food Pantry', 'Retail Bakery'), rotation='vertical')
plt.savefig('allstonBrighton', bbox_inches='tight', pad_inches=.2)
plt.close()
...
plt.title('Back Bay')
plt.xticks(index + .5, ('Food Est.', 'Corner Store', 'Food Pantry', 'Retail Bakery'), rotation='vertical')
plt.savefig('backBay', bbox_inches='tight', pad_inches=.2)
plt.close()
...
plt.title('Central')
plt.xticks(index + .5, ('Food Est.', 'Corner Store', 'Food Pantry', 'Retail Bakery'), rotation='vertical')
plt.savefig('central', bbox_inches='tight', pad_inches=.2)
plt.close()
...
plt.xticks(index + .5, ('Food Est.', 'Corner Store', 'Food Pantry', 'Retail Bakery'), rotation='vertical')
plt.savefig('charlestown', bbox_inches='tight', pad_inches=.2)
plt.close()
...
plt.xticks(index + .5, ('Food Est.', 'Corner Store', 'Food Pantry', 'Retail Bakery'), rotation='vertical')
plt.savefig('eastBoston', bbox_inches='tight', pad_inches=.2)
plt.close()
...
plt.xticks(index + .5, ('Food Est.', 'Corner Store', 'Food Pantry', 'Retail Bakery'), rotation='vertical')
plt.savefig('fenwayKenmore', bbox_inches='tight', pad_inches=.2)
plt.close()
...
plt.xticks(index + .5, ('Food Est.', 'Corner Store', 'Food Pantry', 'Retail Bakery'), rotation='vertical')
plt.savefig('harborIslands', bbox_inches='tight', pad_inches=.2)
plt.close()
...
plt.title('Hyde Park')
plt.xticks(index + .5, ('Food Est.', 'Corner Store', 'Food Pantry', 'Retail Bakery'), rotation='vertical')
plt.savefig('hydePark', bbox_inches='tight', pad_inches=.2)
plt.close()
...
plt.xticks(index + .5, ('Food Est.', 'Corner Store', 'Food Pantry', 'Retail Bakery'), rotation='vertical')
plt.savefig('jamaicaPlain', bbox_inches='tight', pad_inches=.2)
plt.close()
...
plt.title('Mattapan')
plt.xticks(index + .5, ('Food Est.', 'Corner Store', 'Food Pantry', 'Retail Bakery'), rotation='vertical')
plt.savefig('mattapan', bbox_inches='tight', pad_inches=.2)
plt.close()
...
plt.xticks(index + .5, ('Food Est.', 'Corner Store', 'Food Pantry', 'Retail Bakery'), rotation='vertical')
plt.savefig('dorchester', bbox_inches='tight', pad_inches=.2)
plt.close()
...
plt.xticks(index + .5, ('Food Est.', 'Corner Store', 'Food Pantry', 'Retail Bakery'), rotation='vertical')
plt.savefig('roslindale', bbox_inches='tight', pad_inches=.2)
plt.close()
...
plt.title('Roxbury')
plt.xticks(index + .5, ('Food Est.', 'Corner Store', 'Food Pantry', 'Retail Bakery'), rotation='vertical')
plt.savefig('roxbury', bbox_inches='tight', pad_inches=.2)
plt.close()
...
plt.xticks(index + .5, ('Food Est.', 'Corner Store', 'Food Pantry', 'Retail Bakery'), rotation='vertical')
plt.savefig('southBoston', bbox_inches='tight', pad_inches=.2)
plt.close()
...
plt.title('Boston')
plt.xticks(index + .5, ('Food Est.', 'Corner Store', 'Food Pantry', 'Retail Bakery'), rotation='vertical')
plt.savefig('boston', bbox_inches='tight', pad_inches=.2)
plt.close()
...
plt.title('South End')
plt.xticks(index + .5, ('Food Est.', 'Corner Store', 'Food Pantry', 'Retail Bakery'), rotation='vertical')
plt.savefig('southEnd', bbox_inches='tight', pad_inches=.2)
plt.close()
...
plt.xticks(index + .5, ('Food Est.', 'Corner Store', 'Food Pantry', 'Retail Bakery'), rotation='vertical')
plt.savefig('westRoxbury', bbox_inches='tight', pad_inches=.2)
plt.close()
