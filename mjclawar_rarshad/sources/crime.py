...
Description: Crime incidents data from data.cityofboston.gov
...
class CrimeAPIQuery(APIQuery):
    ...
    def download_update_database(self, full_provenance=False):
        ...
        crime_provenance.update_provenance(full_provenance=full_provenance, start_time=start_time, end_time=end_time)
